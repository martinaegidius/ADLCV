    ...
    for epoch in range(1, num_epochs + 1):
        ...
        for i, (images, labels) in enumerate(pbar):
            ...
            if diff_type == 'DDPM-cFg':
                #lottery draw for unconditional training
                p_uncod = 0.1
            ...
            t = diffusion.sample_timesteps(images.shape[0]).to(device) # sample time-steps uniformly between 1...T
        ...
        torch.save(losses,"ddpm_cfg_losses.pt")
